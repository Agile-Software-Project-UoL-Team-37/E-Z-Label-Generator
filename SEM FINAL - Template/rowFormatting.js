function RowFormatting(c)
{
   ...
   // let colorInput = createColorPicker();
    ...
    this.setup2 = function()
    {
        ...
        this.idCell2.initLocalPositions(0, 0, 2, 1);
        ...
        //---------------------------------/  ENABLED  /--------------------------------------
        this.enabledCell2 = new Cell();
        this.enabledCell2.initLocalPositions(2, 0, 2, 1);
        ...
        enabledInput2.position(this.enabledCell2.x + this.enabledCell2.w/5, this.enabledCell2.y + + this.enabledCell2.h/5);
        enabledInput2.size(this.enabledCell2.w/2, this.enabledCell2.h/2);
        ...
        this.nameCell2.initLocalPositions(6, 0, 6, 1);
        ...
        nameInput2.position(this.nameCell2.x + this.nameCell2.w*0.05, this.nameCell2.y + this.nameCell2.h/5);
        nameInput2.size(this.nameCell2.w *0.85, this.nameCell2.h*0.5);
        ...
        //---------------------------------/  SUBTEXT  /--------------------------------------
        this.subtextCell2 = new Cell();
        this.subtextCell2.initLocalPositions(12, 0, 6, 1);
        ...
        subtextInput2.position(this.subtextCell2.x + this.subtextCell2.w*0.05, this.subtextCell2.y + this.subtextCell2.h/5);
        subtextInput2.size(this.subtextCell2.w *0.85, this.subtextCell2.h*0.5);
        ...
        //---------------------------------/  COLOR  /--------------------------------------
        this.colorCell2 = new Cell();
        this.colorCell2.initLocalPositions(4,0, 2,1);
